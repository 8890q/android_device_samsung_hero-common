...
struct SecRadioIndication : public IRadioIndication {
    ...
    Return<void> secCurrentSignalStrength(::android::hardware::radio::V1_0::RadioIndicationType type, const ::vendor::samsung::hardware::radio::V1_2::SecSignalStrength& signalStrength) override;
    Return<void> secImsNetworkStateChanged(::android::hardware::radio::V1_0::RadioIndicationType type, const hidl_vec<int32_t>& regState) override;
    Return<void> oemAcbInfoChanged(::android::hardware::radio::V1_0::RadioIndicationType type, const hidl_vec<int32_t>& acbInfo) override;
    Return<void> oemCsFallback(::android::hardware::radio::V1_0::RadioIndicationType type, int32_t state) override;
    Return<void> oemImsPreferenceChangeInd(::android::hardware::radio::V1_0::RadioIndicationType type, const hidl_vec<int32_t>& imsPref) override;
    Return<void> oemVoiceRadioBearerHoStatusInd(::android::hardware::radio::V1_0::RadioIndicationType type, int32_t state) override;
    Return<void> oemHysteresisDcnInd(::android::hardware::radio::V1_0::RadioIndicationType type) override;
    ...
    Return<void> oemReleaseCompleteMessageInd(int32_t typer, const ::vendor::samsung::hardware::radio::V1_2::OemSSReleaseComplete& result) override;
    ...
    Return<void> oemNrDcParamChangeInd(int32_t type, const ::vendor::samsung::hardware::radio::V1_2::DcParam& dcParam) override;
    Return<void> oemNrSignalStrengthInd(int32_t type, const ::vendor::samsung::hardware::radio::V1_2::NrSignalStrength& nrSignalStrength) override;
    Return<void> oemLoadApnProfile(const hidl_string& select, oemLoadApnProfile_cb _hidl_cb) override;
